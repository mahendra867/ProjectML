...
from src.PROJECTML.pipeline.stage_05_model_evaluation import ModelEvaluationTrainingPipeline
...
try:
   ...
   data_ingestion.main() # here iam calling this main() from DataTransformationTrainingPipeline()
   logger.info(f">>>>>> stage {STAGE_NAME} completed <<<<<<\n\nx==========x")
